    ...
    def get_best_params_for_svm(self, train_x, train_y):
        ...
        try:
            ...
            self.grid = GridSearchCV(
                estimator=self.sv_classifier, param_grid=self.param_grid, cv=5,  verbose=3)
    ...
    def get_best_params_for_xgboost(self, train_x, train_y):
        ...
        try:
            ...
            self.xgb = XGBClassifier(
                criterion=self.criterion, max_depth=self.max_depth, n_estimators=self.n_estimators, n_jobs=-1)
            # training the mew model
